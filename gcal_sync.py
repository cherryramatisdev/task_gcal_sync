...
def init():
    if not os.path.exists(client_id):
        print('Please put client_id.json in {} before proceeding'.format(
            client_id))
        return
    print('Please paste the calendar id :', end='')
    calendar_id_s = str(input())
...
if __name__ == '__main__':
    run([init, sync_from, sync_to, clear])
